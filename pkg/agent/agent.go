...
type Agent struct {
	...
	Client        transport.MerlinCommClient // Client is an object used to make agent communications
...
func (a *Agent) initialCheckIn(host string) bool {
	...
	if err != nil {
		...
		if a.Debug {
			...
			message("warn", fmt.Sprintf("Received Error: %s", err.Error()))
		}
		if a.Debug {
